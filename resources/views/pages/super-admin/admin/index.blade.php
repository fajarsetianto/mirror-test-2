	...
	<script>
		$(document).ready(function(){
			instanceDatatable = $('.datatable').DataTable({
					...
					processing: true,
					serverSide: true,
					ajax: '{!! route("superadmin.management-user.admin.data") !!}',
					columns: [
	...
	<div class="page-header page-header-light">
		<div class="page-header-content header-elements-md-inline">
			<div class="page-title d-flex">
				<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Management Admin</span> - Petugas MONEV</h4>
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			...
			<div class="header-elements">
				<button class="btn bg-purple-400" onclick="component('{{route('superadmin.management-user.admin.create')}}')"><i class="icon-add-to-list"></i> Tambah Admin</button>
			</div>
		</div>
		<hr class="m-0">
		<div class="card-body">
