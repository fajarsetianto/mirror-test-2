	...
	<script>
		$(document).ready(function(){
			...
			instanceDatatable = $('.datatable').DataTable({
					...
					serverSide: true,
					responsive: true,
					ajax: '{!! route("superadmin.monev.indicator-report.detail.indicator.data",[$form->id,$indicator->id]) !!}',
					columns: [
					...
					{data: 'officer_name', name: 'officer_name',searchable: false},
...
<div class="card">
	<div class="card-header header-elements-inline">
		<h6 class="card-title font-weight-semibold">
			Laporan Indikator Form {{$form->name}}
		</h6>
		<div class="header-elements">
			<h3>
				<span class="badge badge-info" style="background-color: {{$indicator->color}}">{{$indicator->description}}</span>
			</h3>
