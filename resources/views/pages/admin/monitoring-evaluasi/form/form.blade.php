<div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Buat Form Monitoring & Evaluasi</h5>
        ...
        <div class="modal-body">
            <form action="" id="modal-form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" required class="form-control" name="name" placeholder="Judul Form Monitoring dan Evaluasi">
                    </div>
                </div>
                <div class="form-group row">
    ...
    $("#modal-form").on('submit', function (e) {
       ...
       $.ajax({
           ...
           success: function (data) {
               ...
               window.location.replace(redirectUrl.replace("%241",data.id));
