    ...
    <div class="sidebar-content">
            ...
            <div class="card-body">
                <div class="media d-flex align-items-center">
                    ...
                    <div class="media-body ">
                        <div class="media-title font-weight-semibold">{{ucfirst(auth('officer')->user()->name)}}</div>
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item" >
                    <a href="{{route('officer.dashboard')}}" class="nav-link {{ (request()->is('petugas')) ? 'active' : '' }}">
                        <i class="icon-home4"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="nav-item nav-item-submenu {{ (request()->is('petugas/monitoring-evaluasi/*')) ? 'nav-item-expanded nav-item-open' : '' }}">
                    <a href="#" class="nav-link"><i class="icon-copy"></i> <span>Monitoring & Evaluasi</span></a>
                    <ul class="nav nav-group-sub" data-submenu-title="Layouts">
                        <li class="nav-item"><a href="{{route('officer.monev.inspection.index')}}" class="nav-link {{ (request()->is('petugas/monitoring-evaluasi/pemeriksaan*')) ? 'active' : '' }}">Pemeriksaan MONEV</a></li>
