...
class NonEducationalInstitutionController extends Controller
{
    ...
    public function create(){
        return view($this->viewNamespace.'form', [
            'url' => route('admin.institution.non-satuan.store'),
        ]);
    }

    public function edit(NonEducationalInstitution $nonEducationalInstitution){
        return view($this->viewNamespace.'form', [
            'url' => route('admin.institution.non-satuan.update',[$nonEducationalInstitution->id]),
            ...
            ->addColumn('actions', function($row){   
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a href="#" class="dropdown-item" onclick="component(`'.route('admin.institution.non-satuan.edit',[$row->id]).'`)"><i class="icon-pencil"></i> Edit</a>
                        <a href="javascript:void(0)" class="dropdown-item" onclick="destroy(`'.route('admin.institution.non-satuan.destroy',[$row->id]).'`)"><i class="icon-trash"></i> Hapus</a>
